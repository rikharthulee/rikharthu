...
export default function Page() {
  return (
    <>
      ...
      <main className="min-h-screen snap-y snap-mandatory overflow-y-scroll scroll-smooth space-y-0">
        ...
        <motion.section
          ...
          className="min-h-screen snap-start flex items-center justify-center bg-white"
        >
          <div className="container grid gap-8 md:grid-cols-2 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-semibold leading-tight tracking-tight">
                I design and build fast, modern websites that help small
                businesses stand out online.
              </h1>
              <p className="mt-4 text-gray-600 max-w-prose">
                From the UK 🇬🇧 - Based in Laos 🇱🇦 - working with clients across

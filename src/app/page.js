    ...
    <>
      ...
      >
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Package
            ...
            price="$399/mo"
            bullets={["Monthly UX tweaks", "Analytics & A/B", "SEO tech fixes"]}
          />
        </div>
      </Section>
      ...
      >
        <div className="grid md:grid-cols-3 gap-6 items-start">
          <div className="md:col-span-2 space-y-3 text-gray-700">
            ...
            <p>
              Location: Luang Prabang ↔ UK. Available for SME sites and light
              web apps.
            </p>
            <p>
              Delivery: Clear scope → fast build → measure → iterate. No fluff.
            </p>
          </div>
      ...
      <footer className="py-10 text-center text-sm text-gray-500">
        <div className="container flex flex-col items-center gap-2">
          <p>© {new Date().getFullYear()} Richard Lee. All rights reserved.</p>
